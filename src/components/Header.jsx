      ...
      <div className="w-full relative bg-[#312f2f46] flex items-center justify-between py-3 px-[3%] lg:px-[1%] xl:px-[4%]  z-50 text-white  top-0 left-0">
        ...
        <div className=" hidden lg:flex absolute top-0 left-0 w-full h-full items-center justify-center ">
          <div className="flex items-center gap-5 font-[500] text-[14.5px] xl:text-[16.6px]">
            <a href="#">
              <span className="hover:text-[#C2A502]">Features </span>
            </a>
            <a href="#">
              <span className="hover:text-[#C2A502]">Whitepaper</span>
            </a>
            <a href="#">
              <span className="hover:text-[#C2A502]">Staking</span>
            </a>
            <a href="#">
              <span className="hover:text-[#C2A502]">TG-GPT App</span>
            </a>
          </div>
        </div>
        <div className="hidden lg:flex items-center z-50 gap-5 ">
          <button className="button border-yellow-200 flex items-center gap-1 bg-gradient-to-r from-[#BD8928]  to-[#795B20] hover:bg-gradient-to-br w-fit text-[#f0f0f0] hover:text-white text-[14.5px] py-1.5 px-4 rounded-md font-[500]">
            Connect Wallet
          </button>
        </div>
        <div
      ...
      {menuOpen && (
        <div className=" absolute z-50 text-white top-0 right-0 w-[90%] h-screen bg-[#201921] flex justify-around px-[4%] flex-col lg:hidden border-white">
          ...
          <div className="flex flex-col items-center gap-5 ">
            ...
            <button className="flex items-center gap-1 bg-gradient-to-r from-[#BD8928]  to-[#795B20] w-fit text-[#f0f0f0] text-[14.5px] py-1.5 px-4 rounded-full font-[500]">
              Connect Wallet
              {/* <div>
                <img
